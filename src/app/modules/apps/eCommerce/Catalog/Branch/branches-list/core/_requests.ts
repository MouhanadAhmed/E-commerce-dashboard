...
const getArchivedBranches = (query?:string): Promise<BranchesQueryResponse> => {
...
const updateBranch = (BranchId: string| undefined,Branch: object): Promise<Branch | undefined> => {
  return axios
...
const updateBranchOrder = (BranchId: string,Order: number): Promise<Branch | undefined> => {
  return axios
...
const deleteSelectedBranches = (BranchIds: Array<ID |string>): Promise<void> => {
