...
import { ChildSubCategories as Category } from '../core/_models'
import { createChildSubCategory, updateChildSubCategory } from '../core/_requests'
...
const ChildSubCategoryEditModalForm: FC<Props> = ({subCategory, isSubCategoryLoading}) => {
    ...
    onSubmit: async (values, {setSubmitting}) => {
      ...
      try {
        if (isNotEmpty(values._id)) {
          await updateChildSubCategory(values?._id,values)
        } else {
          await createChildSubCategory(values)
        }
      } catch (ex) {
        console.error(ex)
      } finally {
...
export {ChildSubCategoryEditModalForm}
