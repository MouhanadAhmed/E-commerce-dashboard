...
import { getAllProductsInSubCategory, updateProductOrderInSubCategory } from '../Subcategories-list/core/_requests';
...
const SubCategoryProductsTable = (id:string) => {
  ...
  const updateProductOrder = useMutation(({productId,order}) => updateProductOrderInSubCategory(id.id,productId,order), {
